...
\usepackage{graphicx, float, amsmath, multirow}
...
In order to measure performance, the cost matrix in Figure 5.1 is applied to each test-instance where the goal is to minimize the cost. \\
