...
First, GraphSLAM was experimented as an offline solver for SLAM problem. In first experiment, as mentioned, noise parameters were set to 1.0, meaning no noise is expected in computations. Results, as expected, were off. Following image shows result of this first experiment.
