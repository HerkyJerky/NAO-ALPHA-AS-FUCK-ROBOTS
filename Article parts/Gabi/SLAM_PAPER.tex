...
The Hough Transform's parameter values $\textit{maxLineGap}$, $\textit{minLineLength}$ and $\textit{minPoints}$ \\
...
Because the four mentioned variables are all dependent on each other they all have to be tested simultaniously. The table containing the experiments and their results can be found in Table A.1 in the appendice.
