...
Above given description of matrices do not include any error values or noise which is the case in perfect world. However, in real-life environment there is going to be noise caused by either motion or measurement motors of robot. So, noise should be somehow handled by GraphSLAM algorithm. Noise is handled by adding approximated error to $\Omega$ and $\xi$ matrices.
