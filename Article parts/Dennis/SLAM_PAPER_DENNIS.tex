...
\subsection{Noise Parameters}
In the experiment to examine the motion-related noise, it was observed that the NAO would often walk in a curve slightly towards the left, as opposed to completely straight ahead. It would also walk roughly 15\% too far.
	The image processing was observed to always overestimate the distance to a landmark. This error seemed to grow as a function of the true distance, but more testing would be required to fit a function to this relation. It was not immediately clear whether or not the relation was linear, quadratic, or something else. It was observed, however, that the error always seemed to be at least a 10\% overestimation. 
	
\subsection{DUMMY SECTION, SHOULD PUT THIS IN SLAM stuff}
